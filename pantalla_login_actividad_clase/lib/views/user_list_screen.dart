...
class UserListScreen extends StatelessWidget {
  final String email; // ← Agregar esta línea

  const UserListScreen({super.key, required this.email}); // ← Modificar constructor
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Bienvenido: $email'), // ← Modificar título para mostrar el email
